<template>
  <div id="sidenav-collapse-main" class="w-auto h-auto collapse navbar-collapse max-height-vh-100 h-100">
    <ul class="navbar-nav">
      <li class="nav-item">
        <sidenav-collapse nav-text="Reservar Turno" :to="{ name: 'Billing' }">
          <template #icon>
            <icon name="dashboard" />
          </template>
        </sidenav-collapse>
      ...
      <li class="nav-item">
        <sidenav-collapse nav-text="Turnos" :to="{ name: 'Dashboard' }">
          <template #icon>
            <icon name="dashboard" />
          </template>
        </sidenav-collapse>
      ...
      <li class="nav-item">
        <sidenav-collapse nav-text="Usuarios" :to="{ name: 'Tables' }">
          <template #icon>
            <icon name="tables" />
          </template>
        </sidenav-collapse>
      ...
      <li class="nav-item">
        <sidenav-collapse nav-text="Perfil" :to="{ name: 'Profile' }">
          <template #icon>
            <icon name="billing" />
          </template>
        </sidenav-collapse>
      ...
      <!-- <li class="mt-3 nav-item">
        <h6 class="text-xs ps-4 text-uppercase font-weight-bolder opacity-6"
          :class="$store.state.isRTL ? 'me-4' : 'ms-2'">PAGES</h6>
      </li>
      <li class="nav-item">
